...
>A partir dessa visão começamos a buscar por alternativas que poderiam atuar como meio de pagamento das passagens, sendo acessível, seguro e fácil de utilizar. A resposta estava na cara, ou melhor, no bolso: nossos smartphones, sem dúvidas, seria uma otima solução.
